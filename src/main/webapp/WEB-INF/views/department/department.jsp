...
<div id="tb">
	<a class="easyui-linkbutton" plain="true" iconCls="icon-add" style="width: 60px;text-align: center" data-cmd="add">添加</a>
	<a class="easyui-linkbutton" plain="true" iconCls="icon-edit" style="width: 60px;text-align: center" data-cmd="edit">编辑</a>
	<a class="easyui-linkbutton" plain="true" iconCls="icon-remove" style="width: 60px;text-align: center" data-cmd="del">删除</a>
	...
	<a class="easyui-linkbutton"  style="width: 80px;text-align: center;" plain="true" iconCls="icon-search" data-cmd="deptAdvance">查询</a>
...
// ============================================	
// 	对所有的按钮操作进行优化,将按钮的操作函数变为json对象的属性
	$(function(){
var buttonDeal={
